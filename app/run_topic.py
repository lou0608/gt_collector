...
MAX_CALLS = int(os.getenv("GT_MAX_CALLS", "5"))  # budget strict anti-429
...
def _bootstrap_exists(topic_slug: str) -> bool:
    ...
    return any(OUTDIR.glob(f"hourly_7d__{topic_slug}__*.csv"))
...
def main():
    ...
    ap.add_argument("--hourly-mode", choices=["auto", "bootstrap", "yesterday"], default="auto",
    ...
    if args.only_hourly:
        ...
        # MODE COMPLET (comme avant) : daily + horaire auto
