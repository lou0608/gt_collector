...
def main():
    ...
    parser = argparse.ArgumentParser(description="Sélectionne le prochain topic et met à jour le pointeur.")
    parser.add_argument("--topics-file", default=str(CONFIG_DIR / "topics.txt"))
    parser.add_argument("--state-file", default=str(STATE_DIR / "topic_pointer.json"))
    parser.add_argument("--out-file", default=str(CONFIG_DIR / "_current_topic.txt"))
    ...
    state["history"].append({"ts_utc": now_utc, "topic": topic, "index": idx, "total_topics": len(topics)})
